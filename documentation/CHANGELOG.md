...
* New: Added support for the FL Studio DirectWave format (reading and writing of non-monolithic DWP programs; the written program folder can be imported into FL Studio Mobile; the mapping of DWB banks and sampled plugins is reconstructed from the names of their sample files). Written programs have not been tested in DirectWave yet.
