...
* New: Added support for the E-mu Emulator IV bank format (E4B). The name of the bank is prepended to the name of a read preset, since the presets of the EOS libraries are only named after their articulation ('Dark Tremolo') and not after the instrument they play. Written banks have not been tested on real hardware yet.
