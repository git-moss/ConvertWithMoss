...
* New: Added support for the Kurzweil PC3 series, Forte, Forte SE, PC4 and K2700 (PC3, P3K, K2P, P3A, PLE, FOR, FSE, PC4, P4S, K27): the programs of these object files are read with their keymaps and user samples, in the sample layout of the PC3K as well as in the one of the Forte generation; PC3K files (P3K), which the PC3K, Forte, PC4 and K2700 load, are written. Written files are not yet verified on hardware.
