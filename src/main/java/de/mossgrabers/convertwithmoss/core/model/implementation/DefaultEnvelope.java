...
public class DefaultEnvelope implements IEnvelope
{
    ...
    static
    {
        DEFAULT_ENVELOPES.put (TagDetector.CATEGORY_ACOUSTIC_DRUMS, ENVELOPE_PERCUSSIVE);
        ...
        DEFAULT_ENVELOPES.put (TagDetector.CATEGORY_DRUMS, ENVELOPE_PERCUSSIVE);
        ...
        DEFAULT_ENVELOPES.put (TagDetector.CATEGORY_KEYBOARDS, ENVELOPE_KEYS);
        ...
        DEFAULT_ENVELOPES.put (TagDetector.CATEGORY_PLUCKS, ENVELOPE_PLUCKED);
