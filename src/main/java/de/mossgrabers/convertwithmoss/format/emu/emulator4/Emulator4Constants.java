...
public class Emulator4Constants
{
    ...
    protected static final byte [] FORM_MAGIC                 = "FORM".getBytes ();
    /** The form type of an E4B bank. */
    protected static final byte [] FORM_TYPE                  = "E4B0".getBytes ();
    /** The tag of the table of contents chunk. */
    protected static final byte [] TOC_TAG                    = "TOC1".getBytes ();
    /** The tag of the MIDI multimap chunk. */
    protected static final byte [] E4MA_TAG                   = "E4Ma".getBytes ();
    /** The tag of a preset chunk. */
    protected static final byte [] PRESET_TAG                 = "E4P1".getBytes ();
    /** The tag of a sample chunk. */
    protected static final byte [] SAMPLE_TAG                 = "E3S1".getBytes ();
    /** The tag of the master setup chunk (always the last chunk, not listed in the TOC). */
    protected static final byte [] EMST_TAG                   = "EMSt".getBytes ();

    /** The length of all name fields (space padded ASCII without a terminator). */
    protected static final int     NAME_LENGTH                = 16;
    /** The size of a TOC entry. */
    protected static final int     TOC_ENTRY_SIZE             = 32;
    /** The size of the E4Ma multimap chunk. */
    protected static final int     E4MA_SIZE                  = 256;
    /** The size of an E3S1 sample header: 2 bytes sample index + the 92 byte EOS sample struct. */
    protected static final int     SAMPLE_HEADER_SIZE         = 94;
    /** The size of the EOS sample struct; all start/end/loop offsets are relative to its start. */
    protected static final int     SAMPLE_STRUCT_SIZE         = 92;
    /** The size of the fixed E4P1 preset header. */
    protected static final int     PRESET_HEADER_SIZE         = 82;
    ...
    protected static final int     VOICE_MOD_SIZE             = 80;
    /** The size of a zone entry in the secondary zone table of a voice. */
    protected static final int     ZONE_ENTRY_SIZE            = 22;

    /** The maximum number of samples in a bank (S000-S999). */
    protected static final int     MAX_SAMPLES                = 1000;
    /** The maximum number of presets in a bank (P000-P999). */
    protected static final int     MAX_PRESETS                = 1000;
    ...
    protected static final int     DEFAULT_RELEASE_RATE       = 0x14;
    /** The filter cutoff key tracking of a +100% Key-to-FilterFreq cord in octaves per octave. */
    protected static final double  FULL_KEY_TRACKING          = 0.713;

    /** The fixed sample play-back rate of the EOS samplers, the reference of the pitch offset. */
    protected static final int     PLAYBACK_RATE              = 44100;
    /** The resolution of the sample pitch offset: 1/64 semi-tones, therefore 768 per octave. */
     ...
     * filter envelope to the cutoff (amount 0 = inactive) and cord 6 routes the key position to the
    ...
    /**
     * Convert a filter cutoff byte to a frequency in Hertz. The curve is exponential from ~57 Hz at
     * 0 to 20 kHz at 255.
     *
    ...
    /**
     * Calculate the sample pitch offset which sets the play-back pitch of a sample. The sampler
     ...
     * play-back rate would otherwise sound one octave too high. The sample rate field of the sample
     ...
     * @return The offset in 1/64 semi-tones, signed, to be written as a 16 bit value
     */
