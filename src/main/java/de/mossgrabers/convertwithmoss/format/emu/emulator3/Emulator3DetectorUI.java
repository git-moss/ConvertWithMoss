...
/**
 * Settings of the E-mu Emulator III detector.
 *
 * @author Jürgen Moßgraber
 */
public class Emulator3DetectorUI extends MetadataSettingsUI
{
     ...
     */
    public Emulator3DetectorUI (final String prefix)
    {
        super (prefix);
    }
    ...
    public Pane getEditPane ()
    {
        ...
        panel.createSeparator ("@IDS_EIII_SOURCE_OPTIONS");

        this.prependBankNameCheckBox = panel.createCheckBox ("@IDS_EIII_PREPEND_BANK_NAME");
