...
/**
 * Constants of the sound banks of the E-mu Emax and Emax II, which are a dump of the whole memory of
 * the sampler. Both samplers use the same structures and differ only in how they store their audio:
 * the Emax companded bytes, the Emax II 16 bit samples. See documentation/design/EMAX_FORMAT.md for
...
public class EmaxConstants
{
    ...
    public static final byte []   SIGNATURE                 = "emaxutil v1.1 Fri Mar 19 13:31:05 1993\n".getBytes (StandardCharsets.US_ASCII);
    ...
    public static final int []    MAX_UPWARD_TRANSPOSE      =
    {
        25,
        18,
        13,
    ...
    {
        0.0010, 0.0100, 0.0200, 0.0350, 0.0450, 0.0590, 0.0720, 0.0850,
        0.0960, 0.1050, 0.1350, 0.1800, 0.2500, 0.3301, 0.4099, 0.5099,
        0.6499, 0.8001, 0.9800, 1.2002, 1.5000, 1.8500, 2.3001, 2.7495,
        3.2006, 3.6490, 4.1506, 4.6995, 5.8159, 7.2017, 8.6939, 10.5013
    };

    /** The hold time in seconds of the 32 values of an envelope hold. */
    private static final double [] ENVELOPE_HOLD_TIME =
    {
        0.0010, 0.0800, 0.1500, 0.2200, 0.2800, 0.3399, 0.4001, 0.4700,
        0.5399, 0.6001, 0.6601, 0.7299, 0.8001, 0.8700, 0.9298, 0.9902,
        1.0497, 1.1199, 1.1803, 1.2498, 1.3096, 1.3700, 1.4398, 1.5000,
        1.5601, 1.6301, 1.6896, 1.7502, 1.8088, 1.8704, 1.9296, 2.0000
    };

    /** The time in seconds of the 32 values of an envelope decay and release. */
    private static final double [] ENVELOPE_DECAY_TIME =
    {
        0.0010, 0.1500, 0.1900, 0.2300, 0.3399, 0.4900, 0.7900, 1.1701,
        1.5601, 2.0598, 2.4396, 2.8895, 3.2303, 3.6196, 4.0395, 4.5211,
        5.0513, 5.6405, 6.6691, 7.4902, 8.3494, 9.3394, 10.4529, 11.6992,
        13.2003, 15.6979, 21.0027, 32.0000, 55.0117, 100.0215, 100.0215, 100.0215
    };
    ...
    private static final double [] ENVELOPE_SUSTAIN_LEVEL =
    {
        ...
        0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00002, 0.00003, 0.00006,
        0.00009, 0.00028, 0.00045, 0.00224, 0.00631, 0.01259, 0.01778, 0.03981,
        0.06310, 0.14125, 0.19953, 0.28184, 0.44668, 0.56234, 0.73104, 1.00000
    };

    /** The rate in Hertz of the 128 values of the LFO rate. */
    private static final double [] LFO_RATE =
    {
        0.133, 0.133, 0.138, 0.144, 0.150, 0.156, 0.163, 0.171,
        0.180, 0.189, 0.200, 0.207, 0.216, 0.225, 0.235, 0.246,
        0.259, 0.272, 0.287, 0.303, 0.322, 0.332, 0.342, 0.353,
        0.364, 0.377, 0.390, 0.404, 0.420, 0.436, 0.454, 0.472,
        0.490, 0.510, 0.531, 0.555, 0.581, 0.609, 0.641, 0.675,
        0.714, 0.740, 0.769, 0.800, 0.833, 0.869, 0.909, 0.952,
        1.000, 1.052, 1.111, 1.149, 1.190, 1.234, 1.282, 1.333,
        1.388, 1.449, 1.515, 1.587, 1.666, 1.739, 1.818, 1.904,
        2.000, 2.105, 2.223, 2.352, 2.501, 2.666, 2.857, 2.933,
        3.012, 3.095, 3.183, 3.279, 3.379, 3.484, 3.598, 3.716,
        3.845, 4.032, 4.237, 4.463, 4.715, 5.001, 5.320, 5.682,
        6.097, 6.580, 7.142, 7.301, 7.463, 7.637, 7.816, 7.998,
        8.195, 8.401, 8.622, 8.849, 9.198, 9.561, 9.944, 10.337,
        10.745, 11.169, 11.616, 12.075, 12.551, 13.046, 13.569, 14.104,
        14.661, 15.239, 15.850, 16.475, 17.125, 17.801, 18.514, 19.245,
        20.004, 20.004, 20.004, 20.004, 20.004, 20.004, 20.004, 20.004
    };

    /** The delay in seconds of the 64 values of the LFO delay. */
    private static final double [] LFO_DELAY_TIME =
    {
        0.0010, 0.0630, 0.1270, 0.1900, 0.2539, 0.3181, 0.3809, 0.4449,
        0.5090, 0.5720, 0.6362, 0.7002, 0.7631, 0.8269, 0.8899, 0.9537,
        1.0151, 1.0811, 1.1447, 1.2093, 1.2716, 1.3364, 1.3980, 1.4632,
        1.5271, 1.5911, 1.6539, 1.7181, 1.7797, 1.8446, 1.9086, 1.9713,
        2.0361, 2.0994, 2.1634, 2.2268, 2.2894, 2.3538, 2.4172, 2.4808,
        2.5432, 2.6087, 2.6728, 2.7352, 2.8008, 2.8629, 2.9248, 2.9880,
        3.0525, 3.1185, 3.1785, 3.2396, 3.3020, 3.3655, 3.4303, 3.4963,
        3.5636, 3.6259, 3.6893, 3.7538, 3.7538, 3.7538, 3.7538, 3.7538
    };

    /** The delay in seconds of the 64 values of the voice delay. */
    private static final double [] VOICE_DELAY_TIME =
    {
        0.0010, 0.0060, 0.0130, 0.0200, 0.0280, 0.0360, 0.0450, 0.0524,
        0.0610, 0.0700, 0.0794, 0.0900, 0.0995, 0.1100, 0.1196, 0.1300,
        0.1400, 0.1507, 0.1622, 0.1746, 0.1880, 0.2031, 0.2193, 0.2367,
        0.2555, 0.2760, 0.3018, 0.3301, 0.3660, 0.4059, 0.4501, 0.4906,
        0.5346, 0.5824, 0.6347, 0.6918, 0.7539, 0.8212, 0.8950, 0.9755,
        1.0631, 1.1580, 1.2621, 1.3755, 1.4992, 1.6330, 1.7797, 1.9397,
        2.1140, 2.3027, 2.5097, 2.7352, 2.9811, 3.2471, 3.5390, 3.8571,
        4.2037, 4.5789, 4.9904, 5.4390, 5.9278, 6.4569, 7.0372, 7.6697
    };

    /** The cutoff frequency in Hertz of the 128 values of the filter frequency. */
    private static final double [] CUTOFF_FREQUENCY =
    {
        20.0, 20.0, 20.0, 20.0, 21.5, 23.0, 25.0, 27.0,
        28.9, 31.0, 33.0, 36.0, 39.0, 37.0, 40.0, 43.0,
        46.0, 48.9, 52.0, 55.9, 60.0, 64.0, 68.0, 71.5,
        75.1, 79.0, 83.8, 89.0, 95.0, 101.0, 108.0, 115.0,
        121.0, 127.0, 133.0, 139.0, 145.0, 151.0, 156.0, 161.0,
        167.0, 173.0, 179.0, 185.0, 191.0, 200.0, 209.9, 220.0,
        230.0, 240.1, 250.0, 260.0, 270.1, 280.1, 290.0, 300.0,
        310.1, 320.1, 330.0, 340.1, 350.0, 380.0, 410.1, 440.0,
        470.0, 499.9, 530.0, 560.2, 590.1, 640.1, 700.1, 759.9,
        820.1, 880.0, 939.9, 999.8, 1059.9, 1120.3, 1180.1, 1240.2,
        1300.4, 1499.8, 1700.1, 1999.7, 2500.6, 3299.6, 4301.3, 5001.2,
        6301.1, 7998.8, 9501.2, 10499.7, 11799.1, 12896.8, 13999.2, 15004.0,
        15997.5, 16997.8, 18196.8, 18697.6, 19002.4, 19201.0, 19301.1, 19401.7,
        19480.3, 19559.2, 19615.8, 19661.2, 19695.3, 19740.8, 19775.1, 19797.9,
        19832.3, 19855.2, 19866.7, 19889.6, 19912.6, 19935.6, 19958.7, 19981.7,
        19981.7, 19981.7, 19981.7, 19981.7, 19981.7, 19981.7, 19981.7, 19981.7
    };
    ...
    private static final double [] RESONANCE =
    {
        ...
        3.0, 3.0, 4.0, 4.0, 4.0, 4.0, 4.5, 5.0,
        5.0, 5.5, 6.0, 6.0, 7.0, 7.0, 7.0, 7.0,
        8.0, 8.0, 8.0, 9.0, 9.0, 9.0, 10.0, 10.0,
        11.0, 11.0, 12.0, 12.0, 13.0, 13.0, 14.0, 14.0,
        15.0, 15.0, 16.0, 16.0, 17.0, 17.0, 18.0, 18.0,
        19.0, 19.0, 20.0, 20.0, 21.0, 22.0, 23.0, 24.0,
        24.0, 25.0, 26.0, 27.0, 28.0, 28.0, 29.0, 30.0,
        31.0, 32.0, 32.0, 33.0, 34.0, 35.0, 36.0, 37.0,
        38.5, 40.0, 41.5, 43.0, 44.0, 45.0, 47.0, 48.0,
        50.3, 52.6, 54.9, 57.2, 59.5, 61.8, 64.1, 66.4,
        68.7, 71.0, 73.3, 75.6, 77.9, 80.2, 82.5, 84.8,
        87.1, 89.4, 91.7, 94.0, 94.0, 94.0, 94.0, 94.0,
    ...
    {
        0.0, 1.0, 3.0, 4.0, 6.0, 7.0, 8.0, 10.0,
     ...
     *
     * @param record The 32 bytes of the voice record
     * @param offset The offset of the parameter in the bit stream
     * @param width The number of bits of the parameter
     * @return The value
     */
    public static int readVoiceField (final byte [] record, final int offset, final int width)
    {
        int value = 0;
     ...
     * @return The value
     */
    public static int readSignedVoiceField (final byte [] record, final int offset, final int width)
    {
        final int value = readVoiceField (record, offset, width);
     ...
     */
    public static void writeVoiceField (final byte [] record, final int offset, final int width, final int value)
    {
        for (int i = 0; i < width; i++)
        {
            final int bit = offset + i;
