...
public class SfzOpcode
{
    ...
    /** SFZ v1. The panning for the region, in decibels. */
    ...
    /** ARIA. The amplitude EG attack slope time. */
    public static final String AMPEG_ATTACK_SHAPE    = "ampeg_attack_shape";
    /** ARIA. The amplitude EG decay slope time. */
    public static final String AMPEG_DECAY_SHAPE     = "ampeg_decay_shape";
    /** ARIA. The amplitude EG release slope time. */
    public static final String AMPEG_RELEASE_SHAPE   = "ampeg_release_shape";
    ...
    /**
     * SFZ v1. The prefix of the amplifier velocity curve opcodes. The full opcode is amp_velcurve_N
     * with N being a velocity from 1 to 127 and the value the amplitude (0..1) at that velocity.
     * Players interpolate linearly between the given points.
     */
    ...
    /** ARIA. The filter EG attack slope time. */
    public static final String FILEG_ATTACK_SHAPE    = "fileg_attack_shape";
    /** ARIA. The filter EG decay slope time. */
    public static final String FILEG_DECAY_SHAPE     = "fileg_decay_shape";
    /** ARIA. The filter EG release slope time. */
    public static final String FILEG_RELEASE_SHAPE   = "fileg_release_shape";
    /** Cakewalk alias. The EG delay time. */
    ...
    /**
     * SFZ v2 alias. The modulation of the filter cutoff by the modulation wheel (MIDI CC 1) in
     * cent.
     */
    ...
    /** ARIA. The pitch EG attack slope time. */
    public static final String PITCHEG_ATTACK_SHAPE  = "pitcheg_attack_shape";
    /** ARIA. The pitch EG decay slope time. */
    public static final String PITCHEG_DECAY_SHAPE   = "pitcheg_decay_shape";
