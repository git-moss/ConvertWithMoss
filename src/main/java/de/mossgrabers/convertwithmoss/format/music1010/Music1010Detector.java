...
public class Music1010Detector extends AbstractDetectorWithMetadataPane<Music1010DetectorTask>
{
    ...
    {
        this.startDetection (new Music1010DetectorTask (this.notifier, multisampleSourceConsumer, performanceSourceConsumer, folder, this.metadataPane, detectPerformances));
    }
}
