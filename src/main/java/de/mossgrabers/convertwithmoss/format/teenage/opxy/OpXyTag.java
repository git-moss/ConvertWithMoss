...
public class OpXyTag
{
    ...
    /**
     * The cross-fade of the loop. The device relates its cross-fade percentage to the whole sample,
     * not to the loop: the stored value is 'percent * framecount' (the device displays a stored
     * 29368 of 166606 frames as 17%; existing presets hold exact integer percentages of their frame
     * count, up to the manual limit of 75%).
     */
