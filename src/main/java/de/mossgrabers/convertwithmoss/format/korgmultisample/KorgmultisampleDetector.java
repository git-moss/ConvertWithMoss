 ...
 */
public class KorgmultisampleDetector extends AbstractDetector<MetadataSettingsUI>
{
    /**
     * Constructor.
     *
    ...
    {
        super ("Korg Wavestate/Modwave", "KorgMultisample", notifier, new MetadataSettingsUI ("KorgMultisample"), ".korgmultisample");
    }
