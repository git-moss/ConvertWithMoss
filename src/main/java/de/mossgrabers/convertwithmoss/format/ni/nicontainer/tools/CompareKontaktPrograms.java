...
import de.mossgrabers.convertwithmoss.format.ni.kontakt.type.kontakt5.KontaktPresetChunkID;
    ...
    public static void main (final String [] args)
    {
        ...
        try (final InputStream inputStream1 = new FileInputStream (new File (args[0])); final InputStream inputStream2 = new FileInputStream (new File (args[1])))
        {
            ...
            if (dataChunk1.getData () instanceof final PresetChunkData preset1 && dataChunk2.getData () instanceof final PresetChunkData preset2)
            {
                ...
                presetAccessor1.readKontaktPresetChunks (preset1.getPresetData ());
                presetAccessor2.readKontaktPresetChunks (preset2.getPresetData ());
                comparePresetChunkList (presetAccessor1.getChunks (), presetAccessor2.getChunks (), 0);
            }
        }
