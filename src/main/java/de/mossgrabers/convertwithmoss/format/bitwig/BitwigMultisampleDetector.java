 ...
 */
public class BitwigMultisampleDetector extends AbstractDetector<EmptySettingsUI>
{
    ...
    {
        super ("Bitwig Multisample", "Bitwig", notifier, EmptySettingsUI.INSTANCE, ".multisample");
    }
