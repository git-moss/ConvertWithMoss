 ...
 */
public class YamahaYsfcDetector extends AbstractDetector<YamahaYsfcDetectorUI>
{
    ...
    static
    {
        ...
        FILTER_TYPE_MAP.put (Integer.valueOf (7), FilterType.HIGH_PASS); // HPF12
        FILTER_TYPE_MAP.put (Integer.valueOf (8), FilterType.BAND_PASS); // BPF12D
        // 9 seems not to be used
        FILTER_TYPE_MAP.put (Integer.valueOf (10), FilterType.BAND_PASS); // BPFw
        FILTER_TYPE_MAP.put (Integer.valueOf (11), FilterType.BAND_PASS); // BPF6
        FILTER_TYPE_MAP.put (Integer.valueOf (12), FilterType.BAND_REJECTION); // BEF12,
        FILTER_TYPE_MAP.put (Integer.valueOf (13), FilterType.BAND_REJECTION); // BEF6
        FILTER_TYPE_MAP.put (Integer.valueOf (14), FilterType.LOW_PASS); // DualLPF
        FILTER_TYPE_MAP.put (Integer.valueOf (15), FilterType.HIGH_PASS); // DualHPF
        FILTER_TYPE_MAP.put (Integer.valueOf (16), FilterType.BAND_PASS); // DualBPF
        FILTER_TYPE_MAP.put (Integer.valueOf (17), FilterType.BAND_REJECTION); // DualBEF
        // 18 seems not to be used
        FILTER_TYPE_MAP.put (Integer.valueOf (19), FilterType.LOW_PASS); // LPF12+BPF6
        ...
        // 9 seems not to be used
        FILTER_POLE_MAP.put (Integer.valueOf (10), Integer.valueOf (1)); // BPFw
        FILTER_POLE_MAP.put (Integer.valueOf (11), Integer.valueOf (1)); // BPF6
        FILTER_POLE_MAP.put (Integer.valueOf (12), Integer.valueOf (2)); // BEF12,
        FILTER_POLE_MAP.put (Integer.valueOf (13), Integer.valueOf (1)); // BEF6
        FILTER_POLE_MAP.put (Integer.valueOf (14), Integer.valueOf (4)); // DualLPF
        FILTER_POLE_MAP.put (Integer.valueOf (15), Integer.valueOf (4)); // DualHPF
        FILTER_POLE_MAP.put (Integer.valueOf (16), Integer.valueOf (4)); // DualBPF
        FILTER_POLE_MAP.put (Integer.valueOf (17), Integer.valueOf (4)); // DualBEF
        // 18 seems not to be used
    ...
    {
        super ("Yamaha YSFC", "Ysfc", notifier, new YamahaYsfcDetectorUI ("Ysfc"), ENDINGS);
    }
    ...
    protected List<IMultisampleSource> readPresetFile (final File file)
    {
        ...
        try
        {
            ...
            if (!waveforms.isEmpty ())
            {
                ...
                if (hasNoPerformanceData || !SUPPORTED_PERFORMANCE_VERSIONS.contains (format) || !this.settingsConfiguration.isSourceTypePerformance ())
                {
    ...
    private List<IMultisampleSource> createMultisamplesFromWaveforms (final YsfcFile ysfcFile) throws IOException
    {
        ...
        {
            final List<YamahaYsfcKeybank> keyBanks = readKeyBanks (dwfmChunks.get (i), ysfcFile.getFileFormat ());
            ...
            final IGroup group = createSampleZones (keyBanks, waveDataItems, name, ysfcFile.getFileFormat ());
            multisampleSource.setGroups (Collections.singletonList (group));
    ...
    private static ISampleZone createSampleZone (final String name, final YamahaYsfcKeybank keybank)
    {
        ...
        zone.setStop (keybank.getSampleLength ());
        return zone;
    }
