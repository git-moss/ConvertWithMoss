...
/**
 * One mapped sample ('sound') of a Soundbox group. This is the structure encoded in the JUCE
 * Base64 text of a S element. The structure has 75 bytes, plug-in versions from 1.0.8 on append
 * another 12 bytes (stretch parameters) which are ignored. See SOUNDBOX_FORMAT.md.
 *
