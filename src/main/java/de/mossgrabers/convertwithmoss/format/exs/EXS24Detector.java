 ...
 */
public class EXS24Detector extends AbstractDetector<MetadataWithSearchHeightSettingsUI>
{
    /**
     * Constructor.
     *
    ...
    {
        super ("Logic EXS24", "EXS24", notifier, new MetadataWithSearchHeightSettingsUI ("EXS24"), ".exs");
    }
