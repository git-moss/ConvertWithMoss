...
public class EXS24Detector extends AbstractDetectorWithMetadataPane<EXS24DetectorTask>
{
    ...
    public void loadSettings (final BasicConfig config)
    {
        ...
        final String value = config.getProperty (this.prefix + DIRECTORY_SEARCH, "2");
    ...
    public Node getEditPane ()
    {
        ...
        panel.createSeparator ("@IDS_EXS_HEADER");
        this.directorySearch = panel.createComboBox ("@IDS_EXS_DIRECTORY_SEARCH", Integer.valueOf (0), Integer.valueOf (1), Integer.valueOf (2), Integer.valueOf (3));
